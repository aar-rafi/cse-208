...
public:
	...
	// void insert(int data, BinomialHeap &temp)
	// {
	// 	temp.head = this->node_initialization(data);
	// 	BinomialHeap newHeap = this->Union(temp);
	// 	this->size++;
	// 	this->head = newHeap.head;
...
int main()
{
	...
	string s;
	// cin >> s;
	//   use switch-case to implement the following operations
